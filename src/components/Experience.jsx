...
function Experience({ close }) {
  return (
    <Spring
      ...
      {(props) => (
        <animated.div className="content__item-experience" style={props}>
          <svg
            onClick={close}
            width="30"
            height="30"
          ...
          <span>
            ...
            Safety Department. Main responsibilities:
            <ul>
              <li>information and analytical support;</li>
              <li>coordination of the company's divisions on traffic safety;</li>
              <li>traffic accident investigation.</li>
            </ul>
            Worked in this company <b>since 2011</b>, starting with ordinary employees.
            Subsequently, occupying leading positions of the lowest and middle management. The main
            responsibilities were - organization of transportation processes.
          </span>
        </animated.div>
      )}
    </Spring>
