...
function Contacts({ close }) {
  return (
    <Spring
      ...
      {(props) => (
        <animated.div className="content__item-contacts" style={props}>
          <svg
            onClick={close}
            width="30"
            height="30"
          ...
          <div className="text">
            <h2>
              ...
              <br />
              Email:
              <a href="mailto:vdiukarev90@gmail.com">vdiukarev90@gmail.com</a>
            </h2>
          </div>
          <div className="social">
            <a href="https://github.com/CheersM">
              <img width={65} height={65} src="/img/github.png" alt="gitHub" />
            </a>
            <a href="https://www.facebook.com/people/%D0%92%D0%BB%D0%B0%D0%B4%D0%B8%D0%BC%D0%B8%D1%80-%D0%94%D1%8E%D0%BA%D0%B0%D1%80%D0%B5%D0%B2/100038876502166/">
              <img width={65} height={65} src="/img/facebook.png" alt="facebook" />
            </a>
            <a href="https://www.linkedin.com/in/%D0%B2%D0%BB%D0%B0%D0%B4%D0%B8%D0%BC%D0%B8%D1%80-%D0%B4%D1%8E%D0%BA%D0%B0%D1%80%D0%B5%D0%B2-2a052218a">
              <img width={65} height={65} src="/img/linkedin.png" alt="LinkedIn" />
            </a>
          </div>
        </animated.div>
      )}
