...
function Education({ close }) {
  return (
    <Spring
      ...
      {(props) => (
        <animated.div className="content__item-education" style={props}>
          <svg
            onClick={close}
            width="30"
            height="30"
          ...
          <h3>
            Ukrainian State Academy of Railway Transport, Faculty of Transportation Process
            Management, received degree – master 2009 – 2012
          </h3>
          <h3>
            Kharkov technical school of railway transport, Faculty of Transportation Organization,
            process engineer 2005 - 2009
          </h3>
        </animated.div>
      )}
    </Spring>
