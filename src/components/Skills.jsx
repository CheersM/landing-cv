...
function Skills({ close }) {
  return (
    <Spring
      ...
      {(props) => (
        <animated.div style={props} className="content__item-skills">
          <svg
            onClick={close}
            width="30"
            height="30"
          ...
          <div>
            ...
            <ul>
              <li>
                <img width={30} height={30} src="/img/html.png" alt="html-logo" />
                HTML5
              </li>
              <li>
                <img width={30} height={30} src="/img/js.png" alt="js-logo" />
                JavaScript(ES6+)
              </li>
              <li>
                <img width={30} height={30} src="/img/react.png" alt="react-logo" />
                React.JS(one love)
              </li>
              <li>
                <img width={30} height={30} src="/img/redux.png" alt="redux-logo" />
                Redux/Redux thunk
              </li>
              <li>
                <img width={30} height={30} src="/img/eslint.png" alt="eslint-logo" />
                ESLint, <img width={30} height={30} src="/img/prettier.png" alt="prettier-logo" />
                Prettier
              </li>
              <li>
                <img width={30} height={30} src="/img/css.png" alt="css-logo" />
                CSS3/
                <img width={30} height={30} src="/img/scss.png" alt="scss-logo" />
                SCSS/CSS Modules/BEM
              </li>
            </ul>
            <h3>and still the best is yet to come...</h3>
          </div>
        </animated.div>
      )}
    </Spring>
